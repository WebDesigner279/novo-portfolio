  ...
  return (
    <div className={styles.page}>
      <main className={styles.main}>
        ...
        <p className={styles.paragraphP}>
          Experiência com tecnologias como HTML, CSS, SCSS, JavaScript e
          TypeScript, além de frameworks e bibliotecas como Vue.js, React.js e
          Next.js.
        </p>
        <p className={styles.paragraphP}>
        ...
        <p className={styles.paragraphP}>
          Este portfólio é uma amostra do que posso fazer, e estou animado para
          colaborar em novos desafios! Vamos construir algo incrível juntos?
        </p>
